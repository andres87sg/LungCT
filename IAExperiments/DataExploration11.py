...
path = 'C:/Users/Andres/Desktop/imexhs/Lung/LungData/TrainMedSeg/CTMedSeg/'
pathmask = 'C:/Users/Andres/Desktop/imexhs/Lung/LungData/TrainMedSeg/MaskMedSeg3/'

listfiles = os.listdir(path)
listfilesmask = os.listdir(pathmask)

listfiles=sorted(listfiles)
listfilesmask=sorted(listfilesmask)

statslist=[]

#%%
for file,maskfile in tqdm.tqdm((zip(listfiles,listfilesmask))):
    im_name = file # Gray level
    im_namemask = maskfile # Segmentation mask
    # print(file)
    # print(maskfile)
...
#%%
x1=dfclass_one.iloc[:,0]
y1=dfclass_one.iloc[:,1]

x2=dfclass_two.iloc[:,0]
y2=dfclass_two.iloc[:,1]

x3=dfclass_three.iloc[:,0]
y3=dfclass_three.iloc[:,1]
...
lngsegm3=np.int16((lngsegm2[:,:,0]*lnginfmask2)*255)
...
lng2=getsmoothmask(np.int16(lng))
ggo2=getsmoothmask(np.int16(ggo))
con2=getsmoothmask(np.int16(con))
